...
PYTHON_PATH="/home/users/zyfeng/Software/anaconda2/bin/"
LDSC_PATH="/home/users/zyfeng/Software/ldsc/"
GWAS=$1
echo "Step 1: Estimating "${GWAS}"'s relevance to 77 human contexts"
#$PYTHON_PATH/python $LDSC_PATH//munge_sumstats.py --sumstats ./Input/${GWAS}.txt --merge-alleles ./Data/w_hm3.snplist --out ./Input/${GWAS} --a1-inc
$PYTHON_PATH/python $LDSC_PATH/ldsc.py --h2 ./Input/${GWAS}.sumstats.gz --ref-ld-chr ./Data/SpecVar/SpecVar. --w-ld-chr ./Data/weights/weights. --overlap-annot --frqfile-chr ./Data/Frq/1000G.EAS.QC. --out ./Results/${GWAS}.SpecVar
...
$PYTHON_PATH/python GetRevTissue.py
